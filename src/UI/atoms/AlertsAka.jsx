...
const AlertsAka = ({ type, message, children }) => {
  const alertStyles = {
  ...
  return (
    <div className={`p-4 mb-4 text-sm rounded-lg ${alertStyles[type]}`} role="alert">
      <span className="font-medium">{children}</span> {message}
    </div>
  );
};

export default AlertsAka;
